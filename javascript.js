...
function background_img_1_on()  //increases the opacity on hover
{
    if (window.innerHeight < window.innerWidth)  //only when the device has a bigger width than its height
    {
        ...
        document.getElementById('box_1').style = "box-shadow: inset 0 0 0.8vw 1.5vw #0093d0; border-radius: 1vw;"
    }
}
...
function background_img_2_on()  //increases the opacity on hover
{
    if (window.innerHeight < window.innerWidth)  //only when the device has a bigger width than its height
    {
        ...
        document.getElementById('box_2').style = "box-shadow: inset 0 0 0.8vw 1.5vw #ffffff; border-radius: 1vw;"
    }
}
...
function background_img_3_on()  //increases the opacity on hover
{
    if (window.innerHeight < window.innerWidth)  //only when the device has a bigger width than its height
    {
        ...
        document.getElementById('box_3').style = "box-shadow: inset 0 0 0.8vw 1.5vw #7a7a7a; border-radius: 1vw;"
    }
}
...
function background_img_4_on()  //increases the opacity on hover
{
    if (window.innerHeight < window.innerWidth)  //only when the device has a bigger width than its height
    {
        ...
        document.getElementById('box_4').style = "box-shadow: inset 0 0 0.8vw 1.5vw #ffffff; border-radius: 1vw;"
    }
}
...
function background_img_5_on()  //increases the opacity on hover
{
    if (window.innerHeight < window.innerWidth)  //only when the device has a bigger width than its height
    {
        ...
        document.getElementById('box_5').style = "box-shadow: inset 0 0 0.8vw 1.5vw #ff008b; border-radius: 1vw;"
    }
}
...
function background_img_6_on()  //increases the opacity on hover
{
    if (window.innerHeight < window.innerWidth)  //only when the device has a bigger width than its height
    {
        ...
        document.getElementById('box_6').style = "box-shadow: inset 0 0 0.8vw 1.5vw #fdcf01; border-radius: 1vw;"
    }
}
...
function background_img_off()   //makes all images invisible as soon as none of the images is being hovered
{
    if (window.innerHeight < window.innerWidth)  //only when the device has a bigger width than its height
    {
        ...
        document.getElementById('box_1').style = "box-shadow: inset 0 0 0 0 #0093d0; border-radius: 1vw;"
        document.getElementById('box_2').style = "box-shadow: inset 0 0 0 0 #ffffff; border-radius: 1vw;"
        document.getElementById('box_3').style = "box-shadow: inset 0 0 0 0 #7a7a7a; border-radius: 1vw;"
        document.getElementById('box_4').style = "box-shadow: inset 0 0 0 0 #ffffff; border-radius: 1vw;"
        document.getElementById('box_5').style = "box-shadow: inset 0 0 0 0 #ff008b; border-radius: 1vw;"
        document.getElementById('box_6').style = "box-shadow: inset 0 0 0 0 #fdcf01; border-radius: 1vw;"
    }
}
...
function open_impressum()   //opens the modal as soon as the "a" tag is clicked "slides from the top to the middle of the page"
{
    ...
    document.getElementById('impressum_shadow').style = "visibility: visible; opacity: 1; transition-duration: 0.5s; backdrop-filter: blur(10px);"          //adds a dark background
}
